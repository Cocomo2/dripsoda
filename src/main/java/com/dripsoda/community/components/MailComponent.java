...
public class MailComponent {
    ...
    public void sendHtml(String from, String to, String subject, String viewName) throws
            MessagingException {
        this.sendHtml(from, to, subject, viewName, new Context());
    }

    public void sendHtml(String from, String to, String subject, String viewName, Context context) throws
            MessagingException {
