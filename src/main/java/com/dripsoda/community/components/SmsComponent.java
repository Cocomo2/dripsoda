...
public class SmsComponent {
    private static final String ACCESS_KEY = "5BalQoaSC4SixRCHteBO";
    private static final String SECRET_KEY = "dZJlbyKTCHvlVZRe5KCj4GzHPs3rY7AwePac8J3b";
    private static final String SERVICE_ID = "ncp:sms:kr:292567079254:study";
    private static final String CALLER = "01047902841";
    ...
    public int send(String to, String content) throws NoSuchAlgorithmException, InvalidKeyException, IOException {
        ...
        HttpURLConnection connection = (HttpURLConnection) new URL(String.format("https://sens.apigw.ntruss.com/sms/v2/services/%s/messages",
                SmsComponent.SERVICE_ID)).openConnection();
